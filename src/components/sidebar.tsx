...
const IconProject = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      strokeWidth="1.5"
    />
    <path d="M5 12C5 14.2091 8.13401 16 12 16C15.866 16 19 14.2091 19 12" stroke="currentColor" strokeWidth="1.5" />
    <path d="M5 16C5 18.2091 8.13401 20 12 20C15.866 20 19 18.2091 19 16" stroke="currentColor" strokeWidth="1.5" />
  </svg>
)
    ...
    <div className="w-60 bg-white border-r sticky top-0 h-screen flex flex-col font-['Inter',sans-serif]">
      <div className="p-4 border-b">
        <div className="flex items-center">
          ...
          <span className="ml-2 font-semibold text-gray-800">Drageasy</span>
        </div>
      </div>
